...
namespace HolographicAppCXX
{
    class HolographicAppCXXMain : public DX::IDeviceNotify
    {
    public:
        HolographicAppCXXMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~HolographicAppCXXMain();
